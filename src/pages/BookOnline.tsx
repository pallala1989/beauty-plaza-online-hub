...
const BookOnline = () => {
  ...
  const handleSubmit = () => {
    // Validation for in-home services
    if (serviceType === "in-home" && (!customerInfo.phone || !customerInfo.email || !customerInfo.address)) {
      toast({
        title: "Required Information Missing",
        description: "Phone, email, and address are required for in-home services.",
        variant: "destructive",
      });
      return;
    }
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle className="flex items-center">
              ...
              {step === 4 && <><MapPin className="mr-2" /> Step 4: Your Information</>}
            </CardTitle>
          </CardHeader>
